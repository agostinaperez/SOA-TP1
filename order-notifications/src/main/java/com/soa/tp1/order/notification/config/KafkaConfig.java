...
import org.springframework.kafka.support.serializer.JacksonJsonDeserializer;  // ← FIX 1: Reemplaza JsonDeserializer
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderValidated> consumerFactory() {
        ...
        props.put("spring.json.trusted.packages", "com.soa.tp1.order.notification.dto");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderValidated> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OrderValidated> factory = 
